...
void update_navigation_buttons(void) {
    ...
    if (g_strcmp0(name, "AetherDock-search_results_scroll") == 0) {
...
void on_prev_page_clicked(GtkWidget *widget, gpointer data) {
    ...
    if (visible) {
        if (g_strcmp0(gtk_widget_get_name(visible), "AetherDock-search_results_scroll") == 0) return;
...
void on_launcher_clicked(GtkWidget *widget, gpointer data) {
    ...
    gtk_widget_set_name(launcher_window, "AetherDock-launcher-window");
    ...
    gtk_widget_set_name(results_scroll, "AetherDock-search_results_scroll");
    ...
    gtk_widget_set_name(prev_button, "AetherDock-nav-button");
    ...
    gtk_widget_set_name(next_button, "AetherDock-nav-button");
...
void create_launcher_button(GtkWidget *box) {
    ...
    gtk_widget_set_name(launcher_button, "AetherDock-launcher-button");
...
void populate_applications_grid(GtkWidget *stack) {
    ...
    for (GList *l = apps; l != NULL; l = l->next) {
        ...
        gtk_widget_set_name(app_btn, "AetherDock-app-grid-button");
