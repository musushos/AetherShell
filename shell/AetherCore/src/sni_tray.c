...
void sni_tray_set_orientation(GtkWidget *widget, GtkOrientation orientation)
{
    (void)widget;
    if (tray_box && GTK_IS_ORIENTABLE(tray_box))
    {
        gtk_orientable_set_orientation(GTK_ORIENTABLE(tray_box), orientation);
    }
}
